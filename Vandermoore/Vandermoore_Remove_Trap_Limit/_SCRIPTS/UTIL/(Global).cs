...
global using DamageReceivedDifficultyEnum       = global::libMBIN.NMS.GameComponents.GcDamageReceivedDifficultyOption.DamageReceivedDifficultyEnum;
global using DeathConsequencesDifficultyEnum    = global::libMBIN.NMS.GameComponents.GcDeathConsequencesDifficultyOption.DeathConsequencesDifficultyEnum;
global using DependsOnHotspotsEnum              = global::libMBIN.NMS.GameComponents.GcBaseLinkGridData.DependsOnHotspotsEnum;
global using DifficultyPresetTypeEnum           = global::libMBIN.NMS.GameComponents.GcDifficultyPresetType.DifficultyPresetTypeEnum;
...
global using FrigateClassEnum                   = global::libMBIN.NMS.GameComponents.GcFrigateClass.FrigateClassEnum;
...
global using InventorySpecialSlotTypeEnum       = global::libMBIN.NMS.GameComponents.GcInventorySpecialSlotType.InventorySpecialSlotTypeEnum;
global using InventoryStackLimitsDifficultyEnum = global::libMBIN.NMS.GameComponents.GcInventoryStackLimitsDifficultyOption.InventoryStackLimitsDifficultyEnum;
global using InventoryStackSizeGroupEnum        = global::libMBIN.NMS.GameComponents.GcInventoryStackSizeGroup.InventoryStackSizeGroupEnum;
global using InventoryTypeEnum                  = global::libMBIN.NMS.GameComponents.GcInventoryType.InventoryTypeEnum;
global using LinkNetworkTypeEnum                = global::libMBIN.NMS.GameComponents.GcLinkNetworkTypes.LinkNetworkTypeEnum;
...
global using ProceduralProductCategoryEnum      = global::libMBIN.NMS.GameComponents.GcProceduralProductCategory.ProceduralProductCategoryEnum;
...
global using RarityEnum                         = global::libMBIN.NMS.GameComponents.GcRarity.RarityEnum;
...
global using ScannerRechargeDifficultyEnum      = global::libMBIN.NMS.GameComponents.GcScannerRechargeDifficultyOption.ScannerRechargeDifficultyEnum;
...
global using SprintingCostDifficultyEnum        = global::libMBIN.NMS.GameComponents.GcSprintingCostDifficultyOption.SprintingCostDifficultyEnum;
...
global using TechListRewardOrderEnum            = global::libMBIN.NMS.GameComponents.GcRewardSpecificTechFromList.TechListRewardOrderEnum;
